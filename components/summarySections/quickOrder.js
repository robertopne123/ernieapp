...
export const QuickOrder = ({ backAction, subscriptions, products }) => {
  const [currentSubscription, setCurrentSubscription] = useState(
    subscriptions.data?.subscription.subscription
  );

  const [orderMoreQty, setOrderMoreQty] = useState(0);
  ...
  return (
    <div className="bg-erniecream flex flex-col h-full gap-4 pb-6">
        ...
        <div className="flex flex-col gap-2 mt-2 mb-4 bg-erniegreen p-4">
          ...
          <div className="flex flex-row gap-4">
            <div className="flex flex-row">
              ...
              >
                <img src="/remove-green.svg" className="w-6 h-6"></img>
              </div>
            ...
            <div className="p-4 bg-erniegold flex-grow">
      ...
      <div className="bg-erniegreen p-4 mx-4">
