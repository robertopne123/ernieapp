export default function Alert({ message, type, close, action }) {
  const actionFromAlert = () => {
    action();
  };

  return (
    <div className="w-full h-full absolute left-0 top-0 flex flex-col justify-center items-center backdrop-blur z-[999]">
      <div className="w-[85%] flex flex-col bg-erniegreen">
        <div className="p-4">
