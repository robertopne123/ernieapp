          ...
          {showingCheckout ? (
            <div>
              {orderComplete ? (
                ...
                <div className="absolute right-0 top-20 h-[calc(100%-80px)] w-full bg-erniedarkcream p-6 lg:p-10 z-[990] flex flex-col gap-4">
                  <div
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="flex flex-col p-6 bg-ernieteal rounded-xl">
                        <p className="font-circular text-erniecream text-sm">
                          Experience issues ordering? Please get in touch with
                          our team:
                        </p>
            ...
            <div className="absolute right-0 top-20 h-[calc(88vh-80px)] lg:h-[calc(100vh-80px)] w-full bg-erniedarkcream p-6 lg:p-10 z-[990] flex flex-col lg:grid lg:grid-cols-2 gap-4 lg:gap-10 overflow-auto">
              <div className="flex flex-col gap-4">
